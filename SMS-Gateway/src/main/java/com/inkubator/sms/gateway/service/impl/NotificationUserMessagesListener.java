...
public class NotificationUserMessagesListener extends IServiceImpl implements MessageListener {
    ...
    public void onMessage(Message message) {
        try {
            ...
            passwordHistory.setPassword(AESUtil.getAESDescription(passwordHistory.getPassword(), SMSGATEWAY.KEYVALUE, SMSGATEWAY.AES_ALGO));
            if (Objects.equals(passwordHistory.getEmailNotification(), SMSGATEWAY.EMAIL_NOTIFICATION_NOT_YET_SEND)) {
